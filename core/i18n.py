...
_TEXT = {
    "zh": {
        ...
        "class_mapping": "类别映射",
        "load_class_mapping": "加载映射文件",
        "mapping_loaded": "映射已加载",
        "mapping_load_failed": "映射加载失败",
        "mapping_cleared": "映射已清除",
        "mapping_enable": "启用映射",
        "select_mapping_file": "选择映射文件",
        "mapping_files": "JSON 文件",
    ...
    "en": {
        ...
        "load_class_mapping": "Load Mapping File",
        "mapping_loaded": "Mapping loaded",
        "mapping_load_failed": "Mapping load failed",
        "mapping_cleared": "Mapping cleared",
        "mapping_enable": "Enable Mapping",
        "select_mapping_file": "Select Mapping File",
        "mapping_files": "JSON Files",
